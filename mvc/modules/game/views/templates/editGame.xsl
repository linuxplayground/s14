		...
		<form name='editGame'>
			...
			<table>
				...
				<tr>
					...
					<td>
						<input>
							<xsl:attribute name='name'>homeTeamScore</xsl:attribute>
							<xsl:attribute name='id'>homeTeamScore</xsl:attribute>
							<xsl:attribute name='type'>Text</xsl:attribute>
							<xsl:attribute name='size'>4</xsl:attribute>
							<xsl:attribute name='value'><xsl:value-of select='homeTeam/score'/></xsl:attribute>
						</input>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input>
							<xsl:attribute name='name'>awayTeamScore</xsl:attribute>
							<xsl:attribute name='id'>awayTeamScore</xsl:attribute>
							<xsl:attribute name='type'>Text</xsl:attribute>
							<xsl:attribute name='size'>4</xsl:attribute>
							<xsl:attribute name='value'><xsl:value-of select='awayTeam/score'/></xsl:attribute>
						</input>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input>
							...
							<xsl:attribute name='value'><xsl:value-of select='round'/></xsl:attribute>
							<xsl:attribute name='type'>text</xsl:attribute>
