				...
				<tr>
					...
					<td valign='top'>
						<table cellspacing='1'  bgcolor='#6699cc'>
							...
							<xsl:apply-templates select='page/bonus' />
						</table>
						<br />
						<button>
							<xsl:attribute name='onClick'>
								<![CDATA[window.location='index.php?action=newBonus&module=bonus'; return false;]]>
							</xsl:attribute>
							New
						</button>
					</td>
...
<xsl:template match="page/bonus">
		<tr>
			...
			<td>
				<button>
					<xsl:attribute name='onclick'>
						<![CDATA[window.location='index.php?action=editBonus&module=bonus&id=]]>
				...
				<button>
					<xsl:attribute name='onclick'>
						<![CDATA[window.location='index.php?action=confirmDeleteBonus&module=bonus&id=]]>
						<xsl:value-of select='id' />
						<![CDATA['; return false;]]>
					</xsl:attribute>
					Delete
