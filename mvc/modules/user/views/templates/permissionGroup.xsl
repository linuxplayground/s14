...
<xsl:template match="/">
	...
	<html>
		...
		<body>
			<h2>Super 14 - Permissions - <xsl:value-of select="page/permission_name" /></h2>
			<hr />
					...
					<td valign='top'>
						<form>
							<xsl:attribute name="action">
								<xsl:text>index.php?action=updatePermissionGroup&amp;module=user&amp;id=</xsl:text>
								<xsl:value-of select="page/permission_id" />
							</xsl:attribute>
