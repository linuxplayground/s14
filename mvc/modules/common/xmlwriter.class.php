...
//
// THANKS to the above for the use of the code below. (  Dave L )
// RENAMED CLASS to XMLWriterObj to resolve conflict with php5 xmlwriter.  ( Dave L )

// LOG ADDED HERE  (  Dave L  )
...
class XMLWriterObj {
	...
	if (isset($xsl) ) {
		$this->xml .= '<?xml-stylesheet type="text/xsl" href="views/templates/'.$xsl.'"?>';
	}
    }
    function _indent() {
