		...
		<body>
			...
			<table width='90%'>
				<tr>
					...
					<td valign='top'>
						<xsl:apply-templates select="page/teams" />
						<br />
						<button>
							<xsl:attribute name='onClick'>
								<![CDATA[window.location='index.php?action=newTeam&module=team']]>
							</xsl:attribute>
							New
						</button>
					</td>
...
<xsl:template match="team">
	<tr>
		...
		<td>
				<button>
					<xsl:attribute name='onclick'>
						<![CDATA[window.location='index.php?action=editTeam&module=team&id=]]>
				...
				<button>
					<xsl:attribute name='onclick'>
						<![CDATA[window.location='index.php?action=confirmDeleteTeam&module=team&id=]]>
						<xsl:value-of select='id' />
						<![CDATA['; return false;]]>
					</xsl:attribute>
					Delete
